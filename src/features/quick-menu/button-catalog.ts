import { TEXT } from "../../extension/constants";
import {
  ADMIN_PAGE_GROUP,
  AI_GROUP,
...
import type { MenuGroup, QuickMenuButtonDescriptor } from "./menu.types";

export type { QuickMenuButtonDescriptor } from "./menu.types";
